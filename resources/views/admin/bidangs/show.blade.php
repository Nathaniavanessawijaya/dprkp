            ...
            <div class="content-body">
                <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">DETAIL BIDANG</h1>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <h6 class="m-0 font-weight-bold text-primary">{{ $bidangs['name'] }}</h6>
                            </div>
                            <div class="card-body">
                                <h6>{{ $bidangs['description'] }}</h6><br>
                                <h6>Jumlah Seksi Saat Ini: {{ $bidangs->seksis->count('pivot.bidangs_id') }}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
